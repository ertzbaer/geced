	...
	<div class="geex-sidebar__wrapper">
		<div class="geex-sidebar__header">
			<a href="#" data-page="dashboard" class="geex-sidebar__logo page-link">
				<img class="logo-lite" src="assets/logo-dark.svg" alt="logo" />
				<img class="logo-dark" src="assets/logo-lite.svg" alt="logo" />
			</a>
		</div>
		<nav class="geex-sidebar__menu-wrapper">
			<ul class="geex-sidebar__menu">
				<li class="geex-sidebar__menu__item has-children">
					<a href="#" class="geex-sidebar__menu__link page-link">
					...
					<ul class="geex-sidebar__submenu">
						...
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="crypto" class="geex-sidebar__menu__link page-link">Crypto</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="invoicing" class="geex-sidebar__menu__link page-link">Invoicing</a>
						</li>
					</ul>
				</li>
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="todo" class="geex-sidebar__menu__link page-link">Todo</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="chat" class="geex-sidebar__menu__link page-link">Chat</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="calendar" class="geex-sidebar__menu__link page-link">Calendar</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="file-manager" class="geex-sidebar__menu__link page-link">File Manager</a>
						</li>
						<li class="geex-sidebar__menu__item">
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="chart" class="geex-sidebar__menu__link page-link">Chart</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="badge.html" class="geex-sidebar__menu__link page-link">Badge</a>
						</li>
						<li class="geex-sidebar__menu__item">
				...
				<li class="geex-sidebar__menu__item has-children">
					...
					<ul class="geex-sidebar__submenu">
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="blog" class="geex-sidebar__menu__link page-link">Blog</a>
						</li>
						<li class="geex-sidebar__menu__item">
							<a href="#" data-page="faq" class="geex-sidebar__menu__link page-link">Faq</a>
						</li>
						<li class="geex-sidebar__menu__item">
