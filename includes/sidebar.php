<div class="geex-sidebar">
    ...
    <div class="geex-sidebar__wrapper">
                ...
                <li class="geex-sidebar__menu__item has-children">
                    ...
                    <ul class="geex-sidebar__submenu">
                        <li class="geex-sidebar__menu__item">
                            <a href="#" data-page="dashboard" class="geex-sidebar__menu__link page-link">Dashboard</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
                            <a href="#" data-page="server" class="geex-sidebar__menu__link page-link">Server Management</a>
                        </li>
                        <li class="geex-sidebar__menu__item">
        ...
        <div class="geex-sidebar__footer">
            <span class="geex-sidebar__footer__title">Geex PHP Template</span>
            <p class="geex-sidebar__footer__copyright">© 2024 Alle Rechte vorbehalten</p>
            <p class="geex-sidebar__footer__author">Dynamisches PHP-Template mit AJAX</p>
        </div>
    </div>
</div>